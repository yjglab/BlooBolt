                  ...
                  <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                      ...
                      <input
                        ...
                        class="placeholder:text-gray-300 mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                      />
                    </div>
                      ...
                      <div class="w-full col-span-3">
                        ...
                        <div class="mt-1 flex rounded-md shadow-sm">
                          ...
                          <input
                            ...
                            id="company-website"
                            class="block placeholder:text-gray-300 w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                    ...
                    <div>
                      ...
                      <div class="mt-1">
                        <textarea
                          ...
                          name="about"
                          rows="3"
                          class="mt-1 placeholder:text-gray-300 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
