                  ...
                  <div className="space-y-6 bg-white px-4 py-5 sm:p-6">
                    ...
                    <div>
                      ...
                      <div className="mt-1 flex items-center">
                        ...
                        <button
                          type="button"
                          className="ml-5 rounded-md border border-slate-300 bg-white py-2 px-3 text-sm font-medium leading-4 text-slate-600 shadow-sm hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                        >
                          Change
                        </button>
                      </div>
