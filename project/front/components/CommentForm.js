...
const CommentForm = () => {
  ...
  return (
    <form action="submit" onSubmit={onSubmit} className="mb-16 relative">
      ...
      <button
        type="submit"
        className="absolute right-2 shadow-md bg-indigo-500 items-center py-2 px-4 text-xs font-medium text-center text-white hover:text-white  rounded focus:ring-4 focus:ring-indigo-200 hover:bg-indigo-600"
      >
        Flash
      </button>
    </form>
