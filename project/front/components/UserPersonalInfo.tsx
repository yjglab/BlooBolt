      ...
      <div className='lg:grid lg:grid-cols-3 lg:gap-6'>
        <div className='lg:col-span-1'>
          <div className='px-4 sm:px-0'>
            <h3 className='text-lg font-medium leading-6 text-slate-600'>개인 정보</h3>
            <p className='mt-1 text-xs text-slate-600'>이 영역에 게시되는 정보는 공개되지 않습니다.</p>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit(onEditPersonalInfo)}>
            <div className='shadow sm:overflow-hidden rounded-md'>
              <div className='space-y-6 bg-white px-4 py-5 sm:p-6'>
                ...
                <div className='col-span-6 sm:col-span-3'>
                  <label htmlFor='realname' className='block text-sm font-medium text-slate-600'>
                    실명
                  </label>
                  <input
                    type='text'
